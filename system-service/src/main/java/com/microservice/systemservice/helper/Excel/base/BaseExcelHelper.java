...
public abstract class BaseExcelHelper<T> implements ExcelHelper<T> {
    ...
    @Override
    public ResultMsg2<Boolean> validate() {
        if (this.workbook == null) {
            return new ResultMsg2<>(false, "No Excel file found",null);
        }
    ...
    public Map checker(int i, DataDictionary ups) {
        return checker2(i,ups);
    }
